...
| **4 · Viral ID** | Detect viral contigs; assess genome quality and completeness | [VirSorter2]({{ '/docs/tools/virsorter2/' | url }}), [VIBRANT]({{ '/docs/tools/vibrant/' | url }}), [VirSorter]({{ '/docs/tools/virsorter/' | url }}), [CheckV]({{ '/docs/tools/checkv/' | url }}) |
